...
\begin{itemize}
	...
	\item Messung durchgeführt, reproduzierbar
	\item Simulation angepasst, dass diese in geringer Abweichung für weitere Variationen genutzt werden kann
...
\begin{itemize}
	\item ein Kurzschluss bewirkt schon eine Verringerung der Impedanz von ca. $\SI{80}{\%}$
	\item mit 7 Kurzschl\"ussen fast kein Einfluss durch RK mehr \textbf{ZAHL!!!!1!!11!!!EINSELF}
