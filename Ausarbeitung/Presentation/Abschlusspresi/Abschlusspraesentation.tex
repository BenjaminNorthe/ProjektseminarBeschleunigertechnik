...
% 	\centering
	\flushleft
	\subfloat[kein KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/0KS}}
	\hspace{0.0312\textwidth}
	\subfloat[1 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/1KS}}
	\hspace{0.0312\textwidth}
	\subfloat[2 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/2KS}}
	\\ \vspace{-1em}
	\subfloat[3 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/3KS}}
% 	\subfloat[4 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/4KS}}
	\hspace{0.0312\textwidth}
	\subfloat[5 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/5KS}}
% 	\subfloat[6 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/6KS}}
	\hspace{0.0312\textwidth}
	\subfloat[7 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/7KS}}
\end{figure}
\vspace{-0.605\textwidth}
\begin{figure}[t]
	\flushright
	\subfloat{\includegraphics[width=0.183\textwidth]{Feldbilder/legend}}
\end{figure}
...
\begin{frame}\frametitle{Backup: Feldbilder Breite und L\"ange}
\vspace{-2.75em}
 \begin{figure}[htb]
% 	\centering
	\centering
	\subfloat[kein KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/0KS}}
	\hspace{0.0312\textwidth}
	\subfloat[1 KS Breite 20]{\includegraphics[height=0.23\textwidth]{Feldbilder/1KSb20}}
	\hspace{0.0312\textwidth}
	\subfloat[1 KS Breite 50]{\includegraphics[height=0.23\textwidth]{Feldbilder/1KSb50}}
	\\ \vspace{-1em}
	\subfloat[2 KS nah zsm.]{\includegraphics[height=0.23\textwidth]{Feldbilder/2KSnah}}
% 	\subfloat[4 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/4KS}}
	\hspace{0.0312\textwidth}
	\subfloat[2 KS Breite 20]{\includegraphics[height=0.23\textwidth]{Feldbilder/2KSb20}}
% 	\subfloat[6 KS]{\includegraphics[height=0.23\textwidth]{Feldbilder/6KS}}
	\hspace{0.0312\textwidth}
	\subfloat[2 KS Breite 50]{\includegraphics[height=0.23\textwidth]{Feldbilder/2KSb50}}
\end{figure}
\end{frame}
