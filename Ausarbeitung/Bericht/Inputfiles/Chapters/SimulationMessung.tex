...
F\"ur die erste Simulation wurde sowohl der Ringkern als auch die Halterung als dissipativ modeliert. In den CST-Einstellung wurde das Adaptive Mesh Refinement ausgeschaltet und eine fixe Meshgr\"o\ss{}e von $\sim3\cdot10^6$ Meshzellen verwendet. Die Simulation zeigt eine gewisse Welligkeit und nach wie vor eine Abweichung zur Messung. Diese Abweichung konnte bis $20MHz$ minimiert werden indem die Ringkernhaltung durch Edelstahl mit $\mu_r = 1$ modeliert.
