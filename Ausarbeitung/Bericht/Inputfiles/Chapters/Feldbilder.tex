...
\begin{figure}[htb]
	\centering
	\subfloat[Ringkern ohne Kurzschl\"usse]{\includegraphics[height=0.42\textwidth]{Feldbilder/0KS}}
	\subfloat[Ringkern mit einem Kurzschluss der Breite $\SI{30}{\milli\meter}$ und der Länge $\SI{160}{\milli\meter}$.]{\includegraphics[height=0.42\textwidth]{Feldbilder/1KS}}
...
\begin{figure}[htb]
	\centering
	\subfloat[Ringkern mit einem Kurzschluss der Breite $\SI{30}{\milli\meter}$ und der Länge $\SI{160}{\milli\meter}$.]{\includegraphics[height=0.42\textwidth]{Feldbilder/1KS}}
	\subfloat[Ringkern mit acht Kurzschl\"ussen der Breite $\SI{30}{\milli\meter}$ und der Länge $\SI{160}{\milli\meter}$.]{\includegraphics[height=0.42\textwidth]{Feldbilder/8KS}}
	\subfloat[Legende]{\includegraphics[height=0.42\textwidth]{Feldbilder/legend}}
